...
placeholder content — `Alexandra Clarke`, a generic hero image, and so on.
...
> Replace every placeholder in this site with my name, "Alexandra Clarke."
> Update the LinkedIn and GitHub links in index.html's social box to my
> profiles: <your LinkedIn URL> and <your GitHub URL>.

Things to personalize:

- [ ] Your name, replacing the placeholder name everywhere it appears.
